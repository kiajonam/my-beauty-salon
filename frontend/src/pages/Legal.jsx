export default function Legal({ type }) {
  ...
  return <div className="legal-page">
    <header className="legal-header"><a className="brand" href="/"><span className="brand-mark">M</span><span>My Beauty Salon</span></a><a href="/">← Zurück zur Website</a></header>
    <main className="legal-content">
      <p className="eyebrow">My Beauty Salon Köln</p>
      <h1>{isPrivacy ? 'Datenschutzerklärung' : 'Impressum'}</h1>
      {isPrivacy ? <>
        <h2>1. Verantwortlicher</h2><p>Verantwortlich für die Verarbeitung personenbezogener Daten auf dieser Website ist My Beauty Salon, Köln, Deutschland. Kontaktdaten und die genaue Geschäftsanschrift sind vor dem produktiven Einsatz zu ergänzen.</p>
        ...
        <h2>Angaben gemäß § 5 DDG</h2><p>My Beauty Salon<br/>Köln, Deutschland</p>
        <h2>Kontakt</h2><p>Telefon: 0221 123 45 67<br/>E-Mail: hello@mybeautysalon.de</p>
